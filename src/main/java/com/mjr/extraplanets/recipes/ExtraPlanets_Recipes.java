...
public class ExtraPlanets_Recipes {
    ...
    private static void registerCircuitFabricatorRecipes() {
        NonNullList<ItemStack> nonNullList = OreDictionary.getOres(ConfigManagerCore.otherModsSilicon);
        int siliconCount = nonNullList.size();
        for (int j = 0; j <= siliconCount; j++) {
            ItemStack silicon;
            if (j == 0) {
                silicon = new ItemStack(GCItems.basicItem, 1, 2);
            } else {
                silicon = nonNullList.get(j - 1);
            }
    ...
    private static void registerSatellitesRecipes() {
        if (Config.MERCURY_SPACE_STATION && Config.MERCURY) {
            ...
            inputMap.put("ingotTin", Integer.valueOf(32));
            inputMap.put("waferAdvanced", Integer.valueOf(1));
            inputMap.put(new ItemStack(ExtraPlanets_Items.INGOT_MERCURY, 1, 0), Integer.valueOf(24));
            inputMap.put(Items.IRON_INGOT, Integer.valueOf(24));
        ...
        if (Config.VENUS_SPACE_STATION) {
            ...
            inputMap.put("ingotTin", Integer.valueOf(32));
            inputMap.put("waferAdvanced", Integer.valueOf(1));
            inputMap.put(new ItemStack(ExtraPlanets_Items.TIER_4_ITEMS, 1, 5), Integer.valueOf(24));
            inputMap.put(Items.IRON_INGOT, Integer.valueOf(24));
        ...
        if (Config.CERES_SPACE_STATION && Config.CERES) {
            ...
            inputMap.put("ingotTin", Integer.valueOf(32));
            inputMap.put("waferAdvanced", Integer.valueOf(1));
            inputMap.put("ingotUranium", Integer.valueOf(24));
            inputMap.put(Items.IRON_INGOT, Integer.valueOf(24));
        ...
        if (Config.JUPITER_SPACE_STATION && Config.JUPITER) {
            HashMap<Object, Integer> inputMap = new HashMap<>();
            inputMap.put("ingotTin", Integer.valueOf(32));
            inputMap.put(new ItemStack(ExtraPlanets_Items.TIER_5_ITEMS, 1, 5), Integer.valueOf(24));
            inputMap.put(new ItemStack(ExtraPlanets_Items.WAFERS, 1, 3), Integer.valueOf(3));
            inputMap.put(Items.IRON_INGOT, Integer.valueOf(24));
        ...
        if (Config.SATURN_SPACE_STATION && Config.SATURN) {
            ...
            inputMap.put("ingotTin", Integer.valueOf(32));
            inputMap.put("waferAdvanced", Integer.valueOf(1));
            inputMap.put(new ItemStack(ExtraPlanets_Items.TIER_6_ITEMS, 1, 5), Integer.valueOf(24));
            inputMap.put(Items.IRON_INGOT, Integer.valueOf(24));
        ...
        if (Config.URANUS_SPACE_STATION && Config.URANUS) {
            HashMap<Object, Integer> inputMap = new HashMap<>();
            inputMap.put("ingotTin", Integer.valueOf(32));
            inputMap.put(new ItemStack(ExtraPlanets_Items.TIER_7_ITEMS, 1, 5), Integer.valueOf(24));
            inputMap.put(new ItemStack(ExtraPlanets_Items.WAFERS, 1, 5), Integer.valueOf(3));
            inputMap.put(Items.IRON_INGOT, Integer.valueOf(24));
        ...
        if (Config.NEPTUNE_SPACE_STATION && Config.NEPTUNE) {
            HashMap<Object, Integer> inputMap = new HashMap<>();
            inputMap.put("ingotTin", Integer.valueOf(32));
            inputMap.put(new ItemStack(ExtraPlanets_Items.TIER_8_ITEMS, 1, 5), Integer.valueOf(24));
            inputMap.put(new ItemStack(ExtraPlanets_Items.WAFERS, 1, 4), Integer.valueOf(3));
            inputMap.put(Items.IRON_INGOT, Integer.valueOf(24));
        ...
        if (Config.PLUTO_SPACE_STATION && Config.PLUTO) {
            ...
            inputMap.put("ingotTin", Integer.valueOf(32));
            inputMap.put("waferAdvanced", Integer.valueOf(1));
            inputMap.put(new ItemStack(ExtraPlanets_Items.TIER_9_ITEMS, 1, 5), Integer.valueOf(24));
            inputMap.put(Items.IRON_INGOT, Integer.valueOf(24));
        ...
        if (Config.ERIS_SPACE_STATION && Config.ERIS) {
            ...
            inputMap.put("waferAdvanced", Integer.valueOf(1));
            inputMap.put(Items.IRON_INGOT, Integer.valueOf(24));
            inputMap.put(new ItemStack(ExtraPlanets_Items.TIER_10_ITEMS, 1, 5), Integer.valueOf(24));
        ...
        if (Config.KEPLER22B_SPACE_STATION && Config.KEPLER22B && Config.KEPLER_SOLAR_SYSTEMS) {
            HashMap<Object, Integer> inputMap = new HashMap<>();
            inputMap.put(new ItemStack(ExtraPlanets_Items.TIER_11_ITEMS, 1, 0), Integer.valueOf(24));
            inputMap.put(new ItemStack(ExtraPlanets_Items.TIER_11_ITEMS, 1, 1), Integer.valueOf(24));
            inputMap.put(new ItemStack(ExtraPlanets_Items.TIER_11_ITEMS, 1, 2), Integer.valueOf(24));
            inputMap.put(new ItemStack(ExtraPlanets_Items.TIER_11_ITEMS, 1, 3), Integer.valueOf(24));
            inputMap.put(new ItemStack(ExtraPlanets_Items.TIER_11_ITEMS, 1, 4), Integer.valueOf(24));
