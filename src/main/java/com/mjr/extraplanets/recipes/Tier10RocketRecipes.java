...
public class Tier10RocketRecipes {
    private static final List<INasaWorkbenchRecipe> tier10RocketRecipes = new ArrayList();

    public Tier10RocketRecipes() {
    }

    public static ItemStack findMatchingTier10RocketRecipe(InventorySchematicTier10Rocket inventoryRocketBench) {
        Iterator var1 = tier10RocketRecipes.iterator();
    ...
    public static void registerRocketCraftingRecipe() {
        ...
        input.put(12, new ItemStack(ExtraPlanets_Items.TIER_10_ITEMS, 1, 1));
        ...
        input.put(16, new ItemStack(ExtraPlanets_Items.TIER_10_ITEMS, 1, 1));
        ...
        addTier10RocketRecipe(new NasaWorkbenchRecipe(new ItemStack(ExtraPlanets_Items.TIER_10_ROCKET, 1, 0), input));
        //HashMap<Integer, ItemStack> input2 = new HashMap(input);
        //input2.put(19, new ItemStack(Blocks.CHEST));
        //input2.put(20, ItemStack.EMPTY);
        //input2.put(21, ItemStack.EMPTY);
        //addTier10RocketRecipe(new NasaWorkbenchRecipe(new ItemStack(ExtraPlanets_Items.TIER_10_ROCKET, 1, 1), input2));
        ...
        //input2.put(20, new ItemStack(Blocks.CHEST));
        //input2.put(21, ItemStack.EMPTY);
        //addTier10RocketRecipe(new NasaWorkbenchRecipe(new ItemStack(ExtraPlanets_Items.TIER_10_ROCKET, 1, 2), input2));
        //input2 = new HashMap(input);
        //input2.put(19, new ItemStack(Blocks.CHEST));
        //input2.put(20, ItemStack.EMPTY);
        //input2.put(21, new ItemStack(Blocks.CHEST));
        ...
        //input2.put(20, new ItemStack(Blocks.CHEST));
        //input2.put(21, new ItemStack(Blocks.CHEST));
        //addTier10RocketRecipe(new NasaWorkbenchRecipe(new ItemStack(ExtraPlanets_Items.TIER_10_ROCKET, 1, 3), input2));
    }
}
