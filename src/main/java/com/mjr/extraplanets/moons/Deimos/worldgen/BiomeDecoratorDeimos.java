...
public class BiomeDecoratorDeimos extends BiomeDecoratorSpace {
    // Custom code
    private static final List<CustomOreGenerationData> customOreList = CustomOreGeneration.getOresForObject("Deimos");
    ...
    protected void decorate() {
        ...
        if (customOreList != null) {
            for (CustomOreGenerationData ore : customOreList) {
                ...
                int minY = ore.minY;
                int maxY = ore.maxY;
                WorldGenerator blockGeneration = new WorldGenMinableMeta(ore.block, ore.clusterSize, ore.meta, ore.useMeta, ExtraPlanets_Blocks.DEIMOS_BLOCKS, 2);
