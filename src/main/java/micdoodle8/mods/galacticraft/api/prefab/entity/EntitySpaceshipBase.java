...
public abstract class EntitySpaceshipBase extends Entity implements IPacketReceiver, IIgnoreShift, ITelemetry {
    ...
    public void decodePacketdata(ByteBuf buffer) {
        ...
        if (this.launchPhase != newLaunchPhase) {
            this.setLaunchPhase(EntitySpaceshipBase.EnumLaunchPhase.values()[newLaunchPhase]);
            if (newLaunchPhase == EntitySpaceshipBase.EnumLaunchPhase.LANDING.ordinal()) {
    ...
    public void setPositionAndRotationDirect(double x, double y, double z, float yaw, float pitch, int posRotationIncrements, boolean b) {
        ...
        if (this.syncAdjustFlag && this.world.isBlockLoaded(new BlockPos(x, 255.0D, z)) && this.hasValidFuel()) {
    ...
    protected void readEntityFromNBT(NBTTagCompound nbt) {
        ...
        if (nbt.getKeySet().contains("ignite")) {
            ...
            if (ignite == 1) {
                this.setLaunchPhase(EntitySpaceshipBase.EnumLaunchPhase.IGNITED);
            }
        }
        ...
        if (hasOldTags) {
            ...
            this.setLaunchPhase(EntitySpaceshipBase.EnumLaunchPhase.values()[nbt.getInteger("launchPhase") - 1]);
        }
    ...
    public boolean getLaunched() {
        return this.launchPhase >= EntitySpaceshipBase.EnumLaunchPhase.LAUNCHED.ordinal();
    }
    ...
    public void onLaunch() {
        MinecraftForge.EVENT_BUS.post(new EntitySpaceshipBase.RocketLaunchEvent(this));
    }
